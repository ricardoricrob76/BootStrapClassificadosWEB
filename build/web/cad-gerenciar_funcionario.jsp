		...
		<div class="row">
			...
			<div class="navbar-header">
					    <button type="button" class="navbar-toggle menu-button" data-toggle="collapse" data-target="#myNavbar">
      					...
      					<a class="navbar-brand logo" href="#">ClassWeb 5</a>
    			</div>
			</div>
			<div class="col-md-8">
...
<div class="container-fluid main" id="page-top">
	<div class="row">
		...
		<div class="col-md-12 some-notes">
            ...
            <div class="text-box">
           <form name="form1" id="form1" method="post" action="ServletGerenciarFuncionario">
          <table border="0">
            <tr> 
              <td width="235">idFuncion&aacute;rio:</td>
              <td width="602"><input name="idfunc" type="text" id="idfunc" /></td>
            </tr>
            <tr> 
              <td>Nome do Funcion&aacute;rio:</td>
              <td><input name="nomefunc" type="text" id="nomefunc" size="50"  /></td>
            </tr>
            <tr> 
              <td height="47">Email:</td>
              <td><input name="emailfunc" type="text" id="emailfunc" size="50"  /></td>
            </tr>
            <tr> 
              <td>Fone:</td>
              <td><input name="fonefunc" type="text" id="fonefunc" size="20"  /></td>
            </tr>
            <tr> 
              <td>Opera&ccedil;&atilde;o:</td>
              <td><input type="submit" name="Submit" value="&lt;&lt;&lt;&lt; Incluir &gt;&gt;&gt;&gt;" />
                - <a href="ServletListagemFuncionario">Listar Todos os Funcion&aacute;rios</a>.</td>
            </tr>
            </table>
        </form>
            </div>
   		...
   		<div class="col-md-12 col-sm-12 col-xs-12 notes-bg">
    		<div class="container">
    			<div class="col-md-8 col-sm-8 col-xs-12">
     				<p>Web Classificados - Sistema aplicado a gestão de Classificados Online.</p>
    			</div>
    			<div class="col-md-offset-1 col-md-2 col-md-offset-1 col-sm-offset-1 col-sm-2 col-sm-offset-1 col-xs-12">
     				<button type="button" class="btn btn-default btneff">Leia Mais</button>
    			</div>
   			</div>
   		</div>
  	</div> 
