...
<%
  ...
  //  Funcionario[] vbFuncionario = (Funcionario[]) request.getSession().getAttribute("listagemgeral");
  //  Sessao[] vbSessao = (Sessao[]) request.getSession().getAttribute("listagemgeral");
  // TipoAnuncio[] vbTipoAnuncio = (TipoAnuncio[]) request.getSession().getAttribute("listagemgeral");
%>
...
<div class="container-fluid main" id="page-top">
	<div class="row">
        ...
        Status da Opera&ccedil;&atilde;o: <strong><font color="#FFFFFF"> Dados Gravados com Sucesso !!!</font></strong><br />
        <br />
