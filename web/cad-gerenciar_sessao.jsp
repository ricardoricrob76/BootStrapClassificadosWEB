...
<div class="container-fluid main" id="page-top">
	<div class="row">
		...
		<div class="col-md-12 some-notes">
			<div class="content">
                <h2> Gerenciar Sessão</h2>
            </div>
            <div class="text-box">
          <form name="form1" id="form1" method="post" action="ServletGerenciarSessao">
          <table border="0">
            <tr> 
              <td width="235">idSess&atilde;o:</td>
              <td width="602"><input name="idsessao" type="text" id="idsessao" /></td>
            </tr>
            <tr> 
              <td>Nome da Sess&atilde;o:</td>
              <td><input name="nomesessao" type="text" id="nomesessao" size="45" maxlength="45" /></td>
            </tr>
            <tr> 
              <td>Opera&ccedil;&atilde;o:</td>
              <td><input type="submit" name="Submit" value="&lt;&lt;&lt;&lt; Incluir &gt;&gt;&gt;&gt;" />
                - <a href="ServletListagemSessao">Listar Todas as Sess&otilde;es</a>.</td>
          </table>
        </form>
            </div>
		</div>
